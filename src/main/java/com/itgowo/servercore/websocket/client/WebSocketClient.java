...
public final class WebSocketClient {
    ...
    static final String URL = System.getProperty("url", "ws://127.0.0.1:1221/websocket");

    public static void main(String[] args) throws Exception {
        URI uri = new URI("ws://127.0.0.1:1221/");
        ...
        try {
            ...
            final WebSocketClientHandler handler = new WebSocketClientHandler(WebSocketClientHandshakerFactory.newHandshaker(uri, WebSocketVersion.V13,
