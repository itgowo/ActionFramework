...
public class HttpUploadServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    static {
        DiskFileUpload.deleteOnExitTemporaryFile = true; // should delete file
                                                         // on exit (in normal
                                                         // exit)
        DiskFileUpload.baseDirectory = "/test"; // system temp directory
        DiskAttribute.deleteOnExitTemporaryFile = true; // should delete file on
                                                        // exit (in normal exit)
        DiskAttribute.baseDirectory = "/test"; // system temp directory
    }
    ...
    private void writeMenu(ChannelHandlerContext ctx) {
        ...
        responseContent.append("<FORM ACTION=\"/111\" METHOD=\"POST\">");
        ...
        responseContent.append("<FORM ACTION=\"/111\" ENCTYPE=\"multipart/form-data\" METHOD=\"POST\">");
        responseContent.append("<input type=hidden name=getform value=\"POST\">");
        responseContent.append("<table border=\"0\">");
        responseContent.append("<tr><td>Fill with value: <br> <input type=text name=\"info\" size=10></td></tr>");
        responseContent.append("<tr><td>Fill with value: <br> <input type=text name=\"secondinfo\" size=20>");
